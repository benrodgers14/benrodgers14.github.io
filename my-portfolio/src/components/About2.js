...
const PageBackground = styled.div`
  width: 100vw;
  min-height: 100vh;
  background: #E6DEB9; // Or use a gradient if you prefer
  display: flex;
...
const About2 = () => {
  const AboutData = [
    ...
    {
      question: "A Slide For Economics",
  ...
  return (
    <PageBackground>
      <SliderContainer>
        <h1 style={{ textAlign: 'center', marginBottom: '32px', color: '#3b2e1e' }}>Quick Information About Me</h1>
        <Subtext>
        ...
        <ArrowRow>
          <ArrowButton onClick={prevCard} disabled={index === 0} aria-label="Previous card">
            &#8592;
          </ArrowButton>
          <ArrowButton onClick={nextCard} disabled={index === AboutData.length - 1} aria-label="Next card">
            &#8594;
          </ArrowButton>
        </ArrowRow>
      </SliderContainer>
